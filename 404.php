...
<head>
    ...
    <title>Will-Mart Sales System - Not Found</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">Population Not Found</p>
                        <p class="text-gray-500 mb-0">The given state and city pair that you are looking for does not exist...</p>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Yulu Wang 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
